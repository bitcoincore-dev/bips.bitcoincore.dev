...
*  `OP_VAULT`<ref><a href="/345" target="_blank">BIP-345</a></ref> is a proposed opcode to implement a 2-step withdrawal process, enabling on-chain reactive security.
*  `OP_CHECKTEMPLATEVERIFY`<ref><a href="/119" target="_blank">BIP-119</a></ref> is a long-proposed opcode to constrain a transaction to a _template_ with a fixed set of outputs.
