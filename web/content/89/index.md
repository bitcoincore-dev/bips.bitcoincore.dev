...
*  Overwrite _blindsecnonce[0:64]_ with 64 zero bytes<ref> This helps prevent accidental nonce reuse. A zeroed _blindsecnonce_ MUST cause subsequent _BlindSign_ calls to fail.</ref>
*  Let _R' = k'⋅G_; fail if _is_infinite(R')_<ref> This check holds except with negligible probability.</ref>
*  Let _s' = (k + e'⋅d) mod n_
