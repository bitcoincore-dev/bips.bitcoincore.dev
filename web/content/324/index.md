...
Additional message type IDs may be defined by other BIPs. They should be added to the <a href="https://github.com/bitcoin/bips/blob/master/bip-0324/message_type_ids.md" target="_blank">message type IDs table</a> to ease coordination.
