...
[Base64](https://datatracker.ietf.org/doc/html/rfc4648) encode the all
64 bytes of entropy. Remove any spaces or new lines inserted by Base64
encoding process. Slice base64 result string on index 0 to \`pwd_len\`.
This slice is the password. As \`pwd_len\` is limited to 86, passwords
...
- DERIVED
  ENTROPY=d7ad61d4a76575c5bad773feeb40299490b224e8e5df6c8ad8fe3d0a6eed7b85ead9fef7bcca8160f0ee48dc6e92b311fc71f2146623cc6952c03ce82c7b63fe
...
Base85 encode the all 64 bytes of entropy. Remove any spaces or new
lines inserted by Base64 encoding process. Slice base85 result string on
index 0 to \`pwd_len\`. This slice is the password. \`pwd_len\` is
