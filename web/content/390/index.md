...
<tt>musig()</tt> expressions take multiple keys and produce an aggregate public key using <a href="/327" target="_blank">BIP-327</a>.
...
<a href="/327" target="_blank">BIP-327</a> introduces the MuSig2 Multi-Signature scheme. It is useful to have a way for keys to be used
...
In the following sections, the term <tt>KEY</tt> refers to key expressions as defined in <a href="/380" target="_blank">BIP-380</a>
and <a href="/389" target="_blank">BIP-389</a>.
...
<a href="/328" target="_blank">BIP-328</a>. The <tt>/NUM/.../*</tt> following the <tt>musig()</tt> specifies
...
The reference implementation is available in Bitcoin Core <a href="https://github.com/bitcoin/bitcoin/pull/31244" target="_blank">PR #31244</a>.
